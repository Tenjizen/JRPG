...
public class NFT_ActionsActivatePlayer : MonoBehaviour
{
    ...
    {
        Debug.Log("Comp 3 activé");
    }
    private void NFTComp_4()
    {
        Debug.Log("Comp 4 activé");
    }
    private void NFTStat_1()
    {
        Debug.Log("Stat 1 activé");
    }
    private void NFTStat_2()
    {
        Debug.Log("Stat 2 activé");
    }
    private void NFTStat_3()
    {
        Debug.Log("Stat 3 activé");
    }
    private void NFTStat_4()
    {
        Debug.Log("Stat 4 activé");
    }
    private void NFTStat_5()
    {
        Debug.Log("Stat 5 activé");
    }
    private void NFTStat_6()
    {
        Debug.Log("Stat 6 activé");
    }
    private void NFTStat_7()
    {
        Debug.Log("Stat 7 activé");
    }
    private void NFTStat_8()
    {
        Debug.Log("Stat 8 activé");
    }
    private void NFTStat_9()
    {
        Debug.Log("Stat 9 activé");
    }
    private void NFTStat_10()
    {
        Debug.Log("Stat 10 activé");
    }
    private void NFTStat_11()
    {
        Debug.Log("Stat 11 activé");
    }
    private void NFTStat_12()
    {
        Debug.Log("Stat 12 activé");
    }
    private void NFTStat_13()
    {
        Debug.Log("Stat 13 activé");
    }
    private void NFTStat_14()
    {
        Debug.Log("Stat 14 activé");
    }
}
